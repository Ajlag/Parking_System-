        ...
        void button_click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                try
                {
                    ...
                    sda.ExecuteNonQuery();
                    MessageBox.Show("Vreme dolaska: " + trenutno.ToString("HH:mm:ss,  dd.MM.yyyy") + "\n" + "Cena po satu: " + cena + " din" + "\n" + "Parking mesto: " + btn.Name);

                    DateTime tr = DateTime.Now;
                    string vreme = tr.ToString("HH:mm:ss,  dd.MM.yyyy");
                    string v = "Vreme dolaska: " + vreme;
                    string c = "Cena po satu: " + cena + " din";
                    string pm = "Parking mesto: " + btn.Name;
