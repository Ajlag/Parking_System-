...
namespace Parking_System
{
    public partial class User : Form
    {
        ...
        void button_click(object sender, EventArgs e)
        {
            ...
            {
                btn.BackColor = Color.Green;
                SqlConnection abc = new SqlConnection("data source=DESKTOP-L1JRQG0;initial catalog=parking_servis;integrated security=True;MultipleActiveResultSets=True;App=EntityFramework&quot;");
                ...
                SqlConnection con2 = new SqlConnection("data source=DESKTOP-L1JRQG0;initial catalog=parking_servis;integrated security=True;MultipleActiveResultSets=True;App=EntityFramework&quot;");
                ...
                MessageBox.Show("Vreme dolaska: " + vremeDolaska + "\n" + "Vreme odlaska: " + vremeOdlaska + "\n" + "Vreme zadrzavanja: " + mesec + "meseci, " + dan + "dana, " + sat + "sati " + "\n" + "Racun: " + racun + " din" + "\n" + "Parking mesto:" + btn.Name);
                SqlConnection con = new SqlConnection("data source=DESKTOP-L1JRQG0;initial catalog=parking_servis;integrated security=True;MultipleActiveResultSets=True;App=EntityFramework&quot;");
                try
                {
                    con.Open();
                    ...
                    {
                        e1.Graphics.DrawString("Vreme dolaska: " + vremeDolaska + "\n" + "Vreme odlaska: " + vremeOdlaska + "\n" + "Vreme zadrzavanja: " + mesec + " meseci, " + dan + " dana, " + sat + " sati " + "\n" + "Racun: " + racun + " din" + "\n" + "Parking mesto:" + btn.Name, new Font("Times New Roman", 12), new SolidBrush(Color.Black), new RectangleF(0, 0, p.DefaultPageSettings.PrintableArea.Width, p.DefaultPageSettings.PrintableArea.Height));
